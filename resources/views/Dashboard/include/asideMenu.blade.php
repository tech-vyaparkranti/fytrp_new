            ...
            <ul class="menu-inner py-1">
              ...
              {{-- <li class="menu-item">
                <a href="{{route("homeDestinationsSlider")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-bulb"></i>
                  <div data-i18n="Analytics">Manage Home Destinations</div>
                </a>
              </li> --}}

              {{-- <li class="menu-item">
                <a href="{{route("awardsSlider")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-bulb"></i>
                  <div data-i18n="Analytics">Manage Awards And Recognition</div>
                </a>
              </li> --}}

              {{-- <li class="menu-item">
                <a href="{{route("ourExpertsSlider")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-bulb"></i>
                  <div data-i18n="Analytics">Manage Our Experts</div>
                </a>
              </li> --}}
              {{-- <li class="menu-item">
                <a href="{{route("Slider")}}" class="menu-link">
              ...
              <li class="menu-item">
                <a href="{{route("packageMaster.index")}}" class="menu-link">
              ...
              <li class="menu-item">
                <a href="{{route("viewDestinationMaster")}}" class="menu-link">
                  ...
                  <div data-i18n="Analytics">Manage Destination</div>
                </a>
              </li>
              {{-- <li class="menu-item">
                <a href="{{route("managePackageCategories")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-category"></i>
                  <div data-i18n="Analytics">Manage Package Category</div>
                </a>
              </li> --}}
              <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="{{route("USP")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-notepad"></i>
                  <div data-i18n="Analytics">Manage USP </div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{route("Choose_Us")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-notepad"></i>
                  <div data-i18n="Analytics">Manage why choose Us </div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{route("testimonialSlider")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-images"></i>
              ...
              <li class="menu-item">
                <a href="{{route("enquiryAdminPage")}}" class="menu-link">
                  ...
                  <div data-i18n="Analytics">Booking Data</div>
                </a>
              </li>
              ...
              <li class="menu-item">
                <a href="{{route("manageNewsLetterData")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-news"></i>
                  <div data-i18n="Analytics">News Letter Subscribers</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{route("manageHotel")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-book-content"></i>
                  <div data-i18n="Analytics">Manage Hotels</div>
                </a>
              </li>
            </ul>
          </aside>