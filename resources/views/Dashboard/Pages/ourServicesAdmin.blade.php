...
@section('script')
    ...
    columns: [
        ...
        { data: 'service_name', name: 'service_name', title: 'Service Name' },
        {
            data: 'service_image',
        ...
        { data: 'service_details', name: 'service_details', title: 'Service Details' },
        { data: 'position', name: 'position', title: 'Service Position' },
        {
            data: 'action',
            name: 'action',
            orderable: false,
