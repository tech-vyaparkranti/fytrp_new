...
@section('content')
    ...
    <x-content-div heading="Manage USP's">
        ...
        $(function() {
            ...
            table = $('.data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: '{{ \App\Models\USPModel::ID }}',
                        name: '{{ \App\Models\USPModel::ID }}',
                        title: 'Id',
                        visible: false
                    },
                    {
                        data: '{{ \App\Models\USPModel::IMAGE }}',
                    ...
                    {
                        data: '{{ \App\Models\USPModel::HEADING_TOP }}',
                        name: '{{ \App\Models\USPModel::HEADING_TOP }}',
                        title: 'Title'
                    },
                    {
                        data: '{{ \App\Models\USPModel::HEADING_MIDDLE }}',
                        name: '{{ \App\Models\USPModel::HEADING_MIDDLE }}',
                        title: 'Content'
                    },
                    {
                        data: '{{ \App\Models\USPModel::SLIDE_STATUS }}',
                        name: '{{ \App\Models\USPModel::SLIDE_STATUS }}',
                        title: 'Status'
                    },
                    {
                        data: '{{ \App\Models\USPModel::SLIDE_SORTING }}',
                        name: '{{ \App\Models\USPModel::SLIDE_SORTING }}',
                        title: 'Sorting'
                    },
                    {
                        data: 'action',
